...
interface LocationState {
  tx?: SymbolTransactionSummary;
}

export default function SymbolTransactionDetail() {
  ...
  if (!tx) {
    return (
      <Box>
        <AppToolBar back="/symbol/transaction/list" title="Transaction details" />
  ...
  return (
    <Box>
      ...
      <Box sx={{ px: 2, mt: 4, display: 'flex', flexDirection: 'column', gap: 1 }}>
        ...
        <Typography sx={{ fontSize: 'large' }}>{tx.amount || '0'} XYM</Typography>
